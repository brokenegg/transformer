...
def _read_and_batch_from_files(
    ...
    batch_size, max_length, max_io_parallelism, lang_dropout, shuffle, repeat,
...
def train_input_fn(params, ctx=None):
  ...
  def f(file_pattern, tgt_lang, rev):
    return _read_and_batch_from_files(
        ...
        params["max_io_parallelism"], params["lang_dropout"], shuffle=True,
...
def eval_input_fn(params, ctx=None):
  ...
  def f(file_pattern, tgt_lang, rev):
    return _read_and_batch_from_files(
        file_pattern, tgt_lang, rev, params["batch_size"], params["max_length"],
        params["max_io_parallelism"], 0.0, shuffle=False, repeat=1,
