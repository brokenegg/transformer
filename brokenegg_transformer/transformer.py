...
from brokenegg_transformer import ffn_layer
from brokenegg_transformer import metrics
from brokenegg_transformer import model_utils
from brokenegg_transformer.utils.tokenizer import EOS_ID
  ...
  def call(self, inputs, training, initial_ids=None):
    ...
    with tf.name_scope("Transformer"):
      ...
      with tf.name_scope("code_attention"):
        ...
        attention_bias = tf.zeros([tf.shape(codes)[0], 1, 1, self.n_codes])
